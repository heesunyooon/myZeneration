...
<header id="header" class="service">
	...
	<!-- <li><a href="${contextPath }/board/bList?memberId=<%= session.getAttribute("memberId") %>">문의하기</a></li>-->
			<li><a href="${contextPath }/member/logout" style="padding-right: 0.3em;">Logout</a></li>
		</ul>
	</nav>
</header>
<!-- /Header PC-->
...
<header id="header-mobile">
	<div class="toggleList">
		<div class="btn">
			<img src="${contextPath }/resources/img/navbar-toggle-b.png">
		</div>
		<ul>
			...
			<li><a href="${contextPath }/core/analysisMz?sex=남,여&age=30대 초반&lifeScore=80&memberId=<%= session.getAttribute("memberId") %>">MZ세대 만족도 비교 서비스</a></li>
	<!-- <li><a href="${contextPath }/board/bList?memberId=<%= session.getAttribute("memberId") %>">문의하기</a></li>-->
			<li style="border-bottom-left-radius: 20px;"><a href="${contextPath }/member/logout" >Log Out</a></li>
		</ul>
	</div>
</header>
<!-- /Header mobile-->
